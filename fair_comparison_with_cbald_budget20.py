"""
Fair comparison of acquisition functions with FIXED initial model + C-BALD.

CRITICAL FIX: All methods now start from the SAME initial model per trial.
This ensures we're measuring the effectiveness of the acquisition function,
not random initialization variance.

Tests:
1. BatchBALD (original)
2. Variance
3. Entropy
4. C-BALD (NEW - Censored BALD)
5. Random
...
from Model_stuff.acquisition import (
    ...
    entropy_of_probs,
    variance_of_probs,
    cbald_censored_regression,  # NEW: C-BALD
    random_knapsack
)
...
def run_comparison(n_trials=5, initial_samples=200, budget=20, increment=60, prefilter_size=500):
    ...
    print("="*70)
    print("FAIR ACQUISITION FUNCTION COMPARISON (FIXED INITIAL MODEL + C-BALD)")
    print("="*70)
    print()
    print("CRITICAL FIX: All methods now start from the SAME initial model!")
    print("This ensures we measure acquisition function effectiveness,")
    print("not random initialization variance.")
    print()
    print("Methods:")
    print("  1. BatchBALD (original)")
    print("  2. Variance")
    print("  3. Entropy")
    print("  4. C-BALD (NEW - Censored BALD)")
    print("  5. Random")
    print()
    print("Settings:")
...
if __name__ == "__main__":
    ...
    print("\nFair comparison with C-BALD complete!")
