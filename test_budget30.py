...
GOAL: Maximize CBALD-Diverse performance with intelligent variations!
...
5. C-BALD (Reference: +0.0173 ± 0.0062)

Settings: 5 trials for statistical significance, budget=30
"""
...
def run_comparison(n_trials=5, initial_samples=200, budget=30, increment=60, prefilter_size=500):
    ...
    print("  5. C-BALD (Reference: +0.0173)")
    print()
    print("Settings:")
