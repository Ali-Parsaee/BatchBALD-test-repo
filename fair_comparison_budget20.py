"""
Fair comparison of acquisition functions with FIXED initial model.
...
def run_comparison(n_trials=5, initial_samples=200, budget=20, increment=60, prefilter_size=500):
    ...
    print("="*70)
    print("FAIR ACQUISITION FUNCTION COMPARISON (FIXED INITIAL MODEL)")
    print("="*70)
    print()
    ...
    if 'BatchBALD' in summary and summary['BatchBALD']['mean_improvement']:
        ...
        for method in ['Variance', 'Entropy', 'Random']:
