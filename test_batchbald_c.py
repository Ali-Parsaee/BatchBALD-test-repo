"""
Testing BatchBALD-C: BatchBALD with C-BALD's death probability weighting.

GOAL: Make BatchBALD beat C-BALD by combining:
- BatchBALD's diversity mechanism (joint entropy)
- C-BALD's information value weighting (death probability)

Tests:
1. BatchBALD-C (NEW - Combines diversity + information value) ⭐
...
Settings: 5 trials, budget=20, prefilter_size=500
"""
...
from Model_stuff.acquisition import (
    ...
    batchbald_c_acquire_budget,  # NEW: BatchBALD-C (improved!)
    entropy_of_probs,
    variance_of_probs,
    ...
    for acq_func, acq_name in acquisition_functions:
        ...
        try:
            if acq_name == 'Random':
                ...
                # BatchBALD and BatchBALD-C variants
...
def run_comparison(n_trials=5, initial_samples=200, budget=20, increment=60, prefilter_size=500):
    ...
    print("="*70)
    print("TESTING BatchBALD-C: Can it beat C-BALD?")
    print("="*70)
    print()
    print("GOAL: Improve BatchBALD to beat C-BALD by combining:")
    print("  - BatchBALD's diversity mechanism (joint entropy)")
    print("  - C-BALD's information value weighting (death probability)")
    print()
    print("Methods:")
    print("  1. BatchBALD-C (NEW - Diversity + Information Value) ⭐")
    ...
    acquisition_functions = [
        (batchbald_c_acquire_budget, 'BatchBALD-C'),  # NEW: Improved BatchBALD!
...
if __name__ == "__main__":
    ...
    print("\nBatchBALD-C test complete! Did it beat C-BALD?")
